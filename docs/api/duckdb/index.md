...
- [DuckQueryError](classes/DuckQueryError.md)
...
- [~~useDuckConn~~](functions/useDuckConn.md)
...
- [getDuckTables](functions/getDuckTables.md)
- [getDuckTableSchema](functions/getDuckTableSchema.md)
- [getDuckTableSchemas](functions/getDuckTableSchemas.md)
- [checkTableExists](functions/checkTableExists.md)
- [dropAllTables](functions/dropAllTables.md)
- [dropTable](functions/dropTable.md)
- [dropFile](functions/dropFile.md)
- [dropAllFiles](functions/dropAllFiles.md)

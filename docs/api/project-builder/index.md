...
- [ProjectStore](type-aliases/ProjectStore.md)
- [CreateProjectSliceProps](type-aliases/CreateProjectSliceProps.md)
- [ProjectPanelInfo](type-aliases/ProjectPanelInfo.md)
...
- [ColumnSpec](type-aliases/ColumnSpec.md)

## Variables

- [ProjectStateContext](variables/ProjectStateContext.md)
- [INITIAL\_BASE\_PROJECT\_STATE](variables/INITIAL_BASE_PROJECT_STATE.md)
- [INITIAL\_BASE\_PROJECT\_CONFIG](variables/INITIAL_BASE_PROJECT_CONFIG.md)
...
- [createProjectSlice](functions/createProjectSlice.md)

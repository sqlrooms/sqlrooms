...
- **Cosmos.gl upgrade**: updates the Cosmos.gl integration to include the latest improvements in this powerful graph visualization library  ([#379](https://github.com/sqlrooms/sqlrooms/pull/379))

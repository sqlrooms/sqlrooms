      ...
      <section className={cn('bg-background flex h-full min-h-0 flex-col')}>
        <div className="border-b px-3 py-3">
          ...
          <p className="text-muted-foreground mt-1 text-xs leading-5">
            Cross-filter flights by departure airport, arrival airport, and an
            approximate airline/operator code derived from the leading callsign
            prefix. Cesium consumes the same Mosaic selection, so the globe
            stays in sync with the charts.
          </p>
        </div>

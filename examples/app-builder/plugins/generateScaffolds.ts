...
/**
 * Generate a JSON manifest exporting WebContainer FileSystemTree objects for
 * all scaffolds found under the given root directory.
 *
 * The output JSON contains:
 * { names: string[], scaffolds: Record<string, FileSystemTree>, defaults: Record<string, {editableFilePath, editableFileContents}> }
 */
export async function generateScaffoldsModule(params: {
  ...
  const fileContents = renderOutputJson(scaffoldNames, trees, defaults);
...
/**
 * Render the JSON output manifest from collected trees and defaults.
 */

...
scenario and per oracle, partitioned by model ID and pinned revision. It does
...
stable enough for release use. Structural state/policy oracles are the first

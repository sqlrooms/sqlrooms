...
- `--ai-rendering-tools`: Enable read-only artifact, document-block, and dashboard-panel image tools for vision-capable models. Can also be set with `SQLROOMS_AI_RENDERING_TOOLS=1`.

...
- Built-in mapStyle IDs are protomaps-light and protomaps-dark. New maps default to the app theme at creation; omit mapStyle on updates to preserve the saved selection. Never put tile API keys in map configs.

...
- 3D CAMERA: For extruded H3/columns/polygons, or arcs (unless getHeight is 0), set spec.initialViewState with pitch 45–60 and optional bearing (e.g. {"pitch":50,"bearing":20}). Allowed in basic mode. Omit pitch for flat 2D maps and for H3 with extruded: false.

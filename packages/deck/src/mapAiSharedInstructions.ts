...
- 3D CAMERA: For H3/columns unless extruded is false (omitted counts as extruded), extruded polygons, or arcs unless getHeight is 0, set spec.initialViewState with pitch 45–60 and optional bearing (e.g. {"pitch":50,"bearing":20}). Allowed in basic mode. Omit pitch for flat 2D maps.

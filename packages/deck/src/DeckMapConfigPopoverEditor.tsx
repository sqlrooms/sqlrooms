...
type DeckMapConfigPopoverEditorProps = {
  value: Record<string, unknown>;
  onApply: (value: Record<string, unknown>) => void;
};

export const DeckMapConfigPopoverEditor: React.FC<
  DeckMapConfigPopoverEditorProps
> = ({value, onApply}) => {
      ...
      >
        <div className="flex flex-col">
          ...
          <div className="flex items-center justify-end gap-2 border-t p-2">
            ...
            <Button
              size="sm"
              disabled={!isDirty || !isValidJsonObject}
              onClick={handleApply}
            >
              Apply
            </Button>

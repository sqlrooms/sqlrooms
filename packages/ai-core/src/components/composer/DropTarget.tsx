 ...
 * native drag events.
 *
 * **Requires a dnd-kit `DndContext` ancestor** — `useDndMonitor` throws
 * outside one, so unlike the other primitives this errors rather than
 * degrading to a no-op. `RoomDndProvider` supplies it inside a room.
 *

...
export function createJsonTheme(options: BaseThemeOptions = {}): Extension {
  ...
  const highlightStyle = HighlightStyle.define([
    // Property keys
    {tag: [t.propertyName], color: 'var(--color-editor-property)'},
    // String values
    {tag: [t.string], color: 'var(--color-editor-string)'},
    // Numbers
    {tag: [t.number], color: 'var(--color-editor-number)'},
    // Keywords (true, false, null)
    {tag: [t.bool, t.null, t.keyword], color: 'var(--color-editor-keyword)'},

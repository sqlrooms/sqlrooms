...
export default function useMosaicClient(
  props: UseMosaicClientProps,
): UseMosaicClientReturn {
  const {enabled, filterSelection, query, throttleDelay = 500} = props;

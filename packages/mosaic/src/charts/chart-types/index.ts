...
export * from './scatter-chart/schema';
...
export {ScatterChartSettingsComponent} from './scatter-chart/ScatterChartSettings';
...
export * from './scatter-chart/definition';
...
export * from './scatter-chart/tool';

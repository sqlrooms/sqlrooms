...
| CLI document dashboard/data-table/html-app/map block creation | Document AI composition and direct document map/local import flows create stateful blocks through block-document slice methods and feature-specific callbacks | Should become CLI commands                                                   | Stage 5: add CLI-owned document commands that wrap lower-level block-document commands without moving document product policy into shared packages.                |
